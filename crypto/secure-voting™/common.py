...
trustee_hostports = [
    ('trustee0.ctf-league.osusec.org', 31317),
    ('trustee1.ctf-league.osusec.org', 31318),
    ('trustee2.ctf-league.osusec.org', 31319),
]
lyells_bot_hostport = ('lyells_bot', 31320)
...
def xor(*values):
    return bytes([reduce(lambda a, b: a ^ b, l) for l in zip(*values)])
